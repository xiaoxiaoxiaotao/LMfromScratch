...
from cs336_basics.Module.bpeTraining import train_bpe
...
def run_multihead_self_attention(
    ...
    model.q_proj.weights.data = q_proj_weight
    model.k_proj.weights.data = k_proj_weight
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    model = multihead_self_attention(d_model,num_heads, theta, max_seq_len)
    model.q_proj.weights.data = q_proj_weight
    model.k_proj.weights.data = k_proj_weight
    model.v_proj.weights.data = v_proj_weight
    model.o_proj.weights.data = o_proj_weight
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    vocab, merges = train_bpe(input_path, special_tokens,8, vocab_size)
    return vocab, merges